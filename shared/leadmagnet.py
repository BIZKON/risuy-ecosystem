...
def build_privacy_policy(
    ...
    *,
    ...
    в РФ), НО финально документ должен УТВЕРДИТЬ ЮРИСТ оператора — ответственность по 152-ФЗ несёт
    оператор (тенант). §6.3 условна по параметру transborder (дефолт True → раскрытие возможной
    трансграничной передачи; «не осуществляется» печатается только при transborder=False = инференс ИИ
