...
- секция «Предложенные знакомства» (модель двусторонняя, commit e7800d5): requested →
  «ожидает подтверждения участников», контактов нет;
...
check("requested — статус «ожидает подтверждения участников» (двусторонний accept)",
      "ожидает подтверждения участников" in html)
